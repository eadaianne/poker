...
function distribuirCartasComuns() {
  ...
  document.getElementById("texto").innerHTML = CARTAS_COMUNS[0].numero + " " + CARTAS_COMUNS[0].naipe
  + ", " + CARTAS_COMUNS[1].numero + " " + CARTAS_COMUNS[1].naipe
  + ", " + CARTAS_COMUNS[2].numero + " " + CARTAS_COMUNS[2].naipe
  + ", " + CARTAS_COMUNS[3].numero + " " + CARTAS_COMUNS[3].naipe
  + ", " + CARTAS_COMUNS[4].numero + " " + CARTAS_COMUNS[4].naipe;
}